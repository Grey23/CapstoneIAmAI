...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['project_id'])) {
    ...
    $stmt = $conn->prepare("UPDATE projects SET project_status = 'Completed', updated_at = NOW() WHERE id = ?");
    ...
    if ($stmt->execute()) {
        ...
        if ($project && $project['project_status'] === 'Completed') {
            $_SESSION['success_message'] = "Project has been approved successfully!";
        } else {
